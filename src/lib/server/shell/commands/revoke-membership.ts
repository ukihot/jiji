import { decideMembership, evolveMembership, type MembershipError, type MembershipEvent } from '$lib/core/membership';
...
import { countActiveAdmins, getMembership, revokeMembershipRow, toStateRow, upsertMembershipState } from '../repository/membership-repository';
...
export async function revokeMembership(db: SqliteDb, input: RevokeMembershipInput): Promise<RevokeMembershipResult> {
	const now = new Date();
